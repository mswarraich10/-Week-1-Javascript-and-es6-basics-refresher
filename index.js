// repo link: https://github.com/mswarraich10/-Week-1-Javascript-and-es6-basics-refresher
...
function GetTotalBottles(litters) {
  const bottles = [1, 3, 5, 7, 10];

  let i = bottles.length - 1;
  let total = 0;
  while (litters > 0) {
...
console.log(GetTotalBottles(888));
